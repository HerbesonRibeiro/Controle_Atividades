...
class RegistroAtividadeView:
    ...
    def _abrir_calendario(self):
        ...
        ttk.Button(top, text="Selecionar", command=set_date).pack(pady=5)

        # Centralizar janela do calendário
    ...
    def _setup_ui(self):
        ...
        ttk.Label(main_frame, text="Registro de Atividades",
        ...
        for row, (label, var_name, default) in enumerate(campos, start=2):
            ...
            if 'combo' in var_name:
                ...
                ttk.Button(frame, text="📅", command=self._abrir_calendario).pack(side='left', padx=5)
